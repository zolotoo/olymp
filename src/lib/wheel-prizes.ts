...
export const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    prize: 'Закрытый гайд',
    neverDrop: true,
    explanation: 'Закрытый авторский гайд по AI-инструментам. Пока в рулетке не выпадает — добавим в розыгрыш в будущих месяцах.',
  },
  {
    label: '20 🍃',
    emoji: '🍃',
  ...
  },
  {
    ...
    neverDrop: true,
    explanation: 'Доступ к закрытым материалам клуба. Пока в рулетке не выпадает — добавим в розыгрыш в будущих месяцах.',
  },
  {
    label: '50 🍃',
    emoji: '🍃',
  ...
  },
  {
    ...
    neverDrop: true,
    explanation: 'Эксклюзивный промокод от наших партнёров VeoSeeBot на доступ к AI-инструментам. Сам приз уже есть, но в рулетке пока не выпадает — добавим в розыгрыш в будущих месяцах.',
  },
  {
    label: '15 🍃',
    emoji: '🍃',
  ...
  },
  {
    ...
    neverDrop: true,
    explanation: 'Скидка 50% на продление подписки в AI Олимп. Пока в рулетке не выпадает — добавим в розыгрыш в будущих месяцах.',
  },
]
